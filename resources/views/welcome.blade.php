...
<head>
    ...
    <title>Livewire pagination</title>
    <meta name="description" content="Paginate search results using Laravel and Livewire.">
...
<body class="min-h-screen bg-cool-gray-100 font-sans">
    <div class="max-w-3xl mx-auto px-4 py-10 sm:px-6 sm:py-12 lg:max-w-4xl lg:px-8 lg:py-16 xl:max-w-5xl">
        <div class="space-y-10 sm:space-y-12 lg:space-y-16 xl:space-y-18">
            <div class="space-y-8 sm:space-y-0 sm:flex sm:items-center sm:justify-between">
                <div class="flex items-center">
                        ...
                        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <g id="10.5″-iPad-Pro-Copy-6" transform="translate(-116.000000, -134.000000)">
                                <g id="Group-3" transform="translate(115.000000, 136.000000)">
                                    <g id="Jelly" style="transform: translateY(-2.98147%);">
                                        <path
                    ...
                    <div class="ml-6 font-semibold text-3xl text-cool-gray-700">
                        Livewire pagination
                    </div>
                </div>
                ...
                <div>
                    <span class="inline-flex rounded-md shadow-sm">
                        <a href="" target="_blank"
                            class="inline-flex items-center px-4 py-2 space-x-2 border border-transparent text-sm leading-5 font-medium rounded-md text-white bg-cool-gray-600 hover:bg-cool-gray-500 focus:outline-none focus:border-cool-gray-700 focus:shadow-outline-cool-gray active:bg-cool-gray-700 transition ease-in-out duration-150">
                            <x-feathericon-github class="h-5 w-5 text-cool-gray-200" />
                            <span>fork it</span>
                        </a>
                    </span>
                </div>
            ...
            <div class="space-y-4 sm:space-y-6 lg:space-y-8 xl:space-y-10">
                <div class="prose prose-sm ms:prose lg:prose-xl mx-auto">
                    <p class="lead">
                        This whole thing is to just figure out Livewire pagination in a clean environment.
                        Mostly because I must of missed something in one of my projects 🤷‍♂️.
                    </p>
                    ...
                    <p>
                        Oh and one more thing, search uses <a href="https://github.com/lorisleiva/laravel-search-string"
                            target="_blank">lorisleiva/laravel-search-string</a>
                        because it's sweet.
                        So this means you can do things 🧙‍♂️ like <code>'dr.' or 'mrs.' sort:name</code>.
                    </p>
                </div>
